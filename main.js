...
planets.forEach((planet) => {
  ...
  newOptionElement.setAttribute("value", planet[0])
  newOptionElement.textContent = planet[0]
...
// 2. Write the code to return the correct weight
  // planet's multiplier * input
  // weight and planetName parameters will be passed from another function
...
// 6. Write code to display the message shown in the screenshot.
  ...
  var displayMessage = document.getElementById('output')
